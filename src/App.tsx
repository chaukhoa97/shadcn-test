...
function App() {
  return (
    ...
    //           </p>
    //           <div className="text-neutrals-darkest divide-y rounded-2xl bg-white p-4">
    ...
    //     </div>
    //   </div>
    //   <div className="text-neutrals-darkest flex h-screen snap-start flex-col items-center bg-white px-6 py-12">
    ...
    //     <div>
    //       <p className="text-neutrals-darkest mb-2 text-sm">Giải pháp</p>
    //       <p className="text-primary-500 mb-6 text-2xl">
    //         Cùng bạn hiện thực ước mơ cá nhân
    //       </p>
    //       <p className="text-neutrals-darkest mb-6 text-base">
    //         Chúng tôi hiểu rằng mỗi người đều có mục tiêu tài chính riêng cần
    //         chinh phục. Và SHB tự hào giới thiệu các sản phẩm toàn diện giúp bạn
    //         hướng tới ước mơ
    //       </p>
    //       <Button>
    //         Khám phá{' '}
    ...
    //     </div>
    //     <p className="mb-4">
    //       SHB chân thành chia sẻ và đồng hành.<br></br> Bạn đang tìm kiếm những
    ...
    //     />
    //     <div>
    //       <p className="text-primary-500 mb-4 text-2xl">
    ...
    //       </div>
    //       <p className="text-neutrals-darkest mb-4">
    ...
    //   </div>
    //   <div className="text-neutrals-darkest snap-start px-6 py-12">
    //     <p className="mb-8 text-[32px]">
    //       Hãy để chúng tôi <span className="text-primary-500">Hỗ trợ</span>
    //     </p>
    //     <div className="flex flex-col gap-2 lg:flex-row">
    //       <div className="border-neutrals-lighter rounded-lg border p-6">
    //         <svg
    //           width="38"
    //           height="44"
    //           viewBox="0 0 38 44"
    ...
    //         <p className="text-primary-500 text-lg">Tìm chi nhánh & ATM</p>
    //       </div>
    //       <div className="border-neutrals-lighter rounded-lg border p-6">
    //         <svg
    //           width="38"
